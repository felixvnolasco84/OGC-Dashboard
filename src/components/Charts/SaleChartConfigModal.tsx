...
export default function SaleChartConfigModal({
  isOpen,
  onClose,
  proyectoId,
  chartId,
  ...
  const allPartidas = useQuery(api.sales_partidas.getBySalesProject, {
    salesProjectId: proyectoId as Id<"sales_projects">,
  });
