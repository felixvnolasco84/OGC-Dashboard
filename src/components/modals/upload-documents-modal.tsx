...
export default function UploadDocumentsModal() {
    const { isOpen, onClose, transactionId: initialTransactionId, projectId: initialProjectId } = useUploadDocumentsModal();
    ...
    }, [isOpen, initialProjectId, initialTransactionId]);
    ...
    const uploadSingleFile = async (fileUpload: FileUpload, index: number): Promise<boolean> => {
        if (!selectedTransactionId || !selectedProjectId) {
    ...
    const canUpload = selectedProjectId && selectedTransactionId && files.length > 0 && !isUploading;
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <Select
                                ...
                                onValueChange={(value) => {
                                    setSelectedProjectId(value as Id<"desarrollos">);
                    ...
                    <div className="border-2 border-dashed border-border-strong rounded-none p-8 text-center hover:border-border-strong transition-colors">
                        <input
                            ...
                            className="hidden"
                            accept="image/*,.xml,.pdf,.doc,.docx,.xls,.xlsx"
                        />
