        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-3">
              ...
              />
              <span className="text-sm text-gray-600">{localConfig.color}</span>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="border border-gray-200 rounded-lg p-4 max-h-48 overflow-y-auto bg-gray-50">
              {availablePartidas.length === 0 ? (
                <p className="text-sm text-gray-500">No hay partidas disponibles</p>
              ) : (
                <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <div className="border border-gray-200 rounded-lg p-4 max-h-48 overflow-y-auto bg-gray-50">
              {availableFamilias.length === 0 ? (
                <p className="text-sm text-gray-500">No hay familias disponibles</p>
              ) : (
                <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <div className="border border-gray-200 rounded-lg p-4 max-h-48 overflow-y-auto bg-gray-50">
              {availableSubPartidas.length === 0 ? (
                <p className="text-sm text-gray-500">No hay sub-partidas disponibles</p>
              ) : (
                <div className="space-y-2">
