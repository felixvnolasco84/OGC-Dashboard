  ...
  "inline-flex items-center rounded-full border px-2.5 py-1 text-xs font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        success:
          "border-transparent bg-green-100 text-green-800 hover:bg-green-200 rounded-xl",
        danger:
          "border-transparent bg-red-100 text-red-800 hover:bg-red-200 rounded-xl",
        neutral:
          "border-2 border-border bg-muted text-foreground hover:bg-disabled rounded-xl",
      },
    },
    defaultVariants: {
      variant: "default",
