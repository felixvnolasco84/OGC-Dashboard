  ...
  return (
    <div className="bg-card min-h-screen">
      <div className="max-w-full mx-auto py-8 text-left">
        ...
        {/* Table */}
        <div className="mx-4 overflow-hidden border border-border rounded-none sm:mx-6 lg:mx-12">
          <table className="w-full table-fixed border-collapse">
            ...
            <thead className="hidden border-b border-border md:table-header-group">
              <tr>
                <th className="border-r border-border px-4 py-4 text-left text-sm font-normal text-muted-foreground lg:px-6">
                  Documento
                </th>
                <th className="border-r border-border px-4 py-4 text-left text-sm font-normal text-muted-foreground lg:px-6">
                  Cliente
                ...
                <th className="px-4 py-4 text-left text-sm font-normal text-muted-foreground lg:px-6">
                  Transacción
                </th>
              </tr>
            </thead>
              ...
              {!documentos ? (
                ...
                filteredDocumentos?.map((doc) => {
                  ...
                  return (
                    <tr
                      key={doc._id}
                      className="block p-4 transition-colors hover:bg-background md:table-row md:p-0"
                    >
                      <td className="block pb-4 md:table-cell md:border-r md:border-border md:px-4 md:py-4 lg:px-6">
                        <div className="flex min-w-0 items-start gap-3">
                          <FileText className="mt-0.5 h-5 w-5 flex-none text-disabled-foreground" />
                          <div className="min-w-0">
                      ...
                      <td className="flex items-start justify-between gap-4 py-2 text-sm text-foreground md:table-cell md:border-r md:border-border md:px-4 md:py-4 lg:px-6">
                        <span className="flex-none text-xs font-medium uppercase tracking-wide text-disabled-foreground md:hidden">
                          Cliente
                        </span>
                      ...
                      <td className="flex items-start justify-between gap-4 py-2 md:table-cell md:border-r md:border-border md:px-4 md:py-4 lg:px-6">
                        <span className="flex-none text-xs font-medium uppercase tracking-wide text-disabled-foreground md:hidden">
                          Tipo
                        </span>
                        <Badge
                      ...
                      <td className="flex items-start justify-between gap-4 pt-2 text-sm text-foreground md:table-cell md:px-4 md:py-4 lg:px-6">
                        <span className="flex-none text-xs font-medium uppercase tracking-wide text-disabled-foreground md:hidden">
                          Transacción
                        </span>
                        <span className="min-w-0 break-words text-right md:text-left">
