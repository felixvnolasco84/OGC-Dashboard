...
import { Archive, Edit2, FileSpreadsheet, Merge, MoreVertical, Plus, ReceiptText, RefreshCw, RotateCcw, Search } from "lucide-react";
          ...
          <tbody className="divide-y divide-border">
            {!providers ? (
              ...
              <tr key={provider._id} className="hover:bg-background">
                <td className="border-r px-5 py-4 text-left text-sm font-medium">{provider.razon_social}</td>
                ...
                <td className="px-4 py-4 text-left">
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild><Button variant="ghost" size="icon" aria-label={`Acciones para ${provider.razon_social}`}><MoreVertical className="h-4 w-4" /></Button></DropdownMenuTrigger>
