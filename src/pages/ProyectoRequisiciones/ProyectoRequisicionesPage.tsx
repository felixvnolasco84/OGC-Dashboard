...
import { Search, MoreVertical, Plus, ArrowUp, ArrowDown, X, Filter, FileText, ExternalLink } from "lucide-react";
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-4 text-sm border-r border-gray-200">
                                            <Badge variant="outline" className={`capitalize ${
                                                req.tipo === "material" ? "bg-blue-50 text-blue-700" : "bg-purple-50 text-purple-700"
                                            }`}>
                                                {req.tipo}
                                            </Badge>
                                        </td>
                                            ...
                                            <div className="flex flex-col gap-1">
                                                {req.items?.slice(0, 2).map((item, idx) => (
                                                    <span key={idx} className="text-xs text-gray-600">
                                                        {item.sub_partida || item.familia} - {item.cantidad} {item.unidad}
                                                    </span>
                                                ))}
                                            ...
                                            {req.documentos && req.documentos.length > 0 ? (
                                                ...
                                                >
                                                    ...
                                                    {req.documentos.length > 1 && (
                                                        <span className="text-xs text-gray-400">+{req.documentos.length - 1}</span>
                                                    )}
                                                </div>
                                            ) : (
                                        ...
                                        <td className="px-6 py-4">
                                            <Popover>
                                                ...
                                                <PopoverContent className="flex flex-col space-y-1 w-48" align="end">
                                                    <Button 
                                                        variant="ghost" 
